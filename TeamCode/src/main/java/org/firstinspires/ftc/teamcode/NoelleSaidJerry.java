...
public class NoelleSaidJerry extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            boolean forward = gamepad1.left_stick_y > 0.2 || gamepad1.dpad_up;
            boolean backward = gamepad1.left_stick_y < -0.2 || gamepad1.dpad_down;
            boolean left = gamepad1.left_stick_x > 0.2 || gamepad1.dpad_left;
            boolean right = gamepad1.left_stick_x < -0.2 || gamepad1.dpad_right;
            boolean turnLeft = gamepad1.right_stick_x < -0.2;
            boolean turnRight = gamepad1.right_stick_x > 0.2;
            boolean stopDrive = gamepad1.left_trigger > 0.25 || !(forward || backward || left || right || turnLeft || turnRight);
